...
BOT_TOKEN = environ.get('BOT_TOKEN', "6725769730:AAFlMmWseDDJW3WPlGtACR3klrAs_OeAm_k")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002082507513'))
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002081769204').split()]
